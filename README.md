...
[![Build Status](https://travis-ci.org/winwong03/hystrix-go.png?branch=master)](https://travis-ci.org/winwong03/hystrix-go)
[![GoDoc Documentation](http://godoc.org/github.com/winwong03/hystrix-go/hystrix?status.png)](https://godoc.org/github.com/winwong03/hystrix-go/hystrix)
...
For API documentation, refer to [GoDoc](https://godoc.org/github.com/winwong03/hystrix-go/hystrix)

How to use
----------

```go
import "github.com/winwong03/hystrix-go/hystrix"
```
...
- ```cd /go/src/github.com/winwong03/hystrix-go```
- ```go test ./...```
